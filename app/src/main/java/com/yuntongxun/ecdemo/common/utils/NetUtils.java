...
//        String s = "http://192.168.21.47:9060/2016-08-15/Application/"+CCPAppManager.getClientUser().getAppKey()+"/IMPlus/MessageReceipt?sig="+getSig();
        String s = "http://imslb.yuntongxun.com:8999/2016-08-15/Application/"+CCPAppManager.getClientUser().getAppKey()+"/IMPlus/MessageReceipt?sig="+getSig();
        return s;
    }
