...
//        boolean isFireMsg= IMessageSqlManager.isFireMsg(mEntry.getMsgLocalId());
        ...
        boolean isTrue = ImageGralleryPagerActivity.sgId.equalsIgnoreCase(mEntry.getMsgLocalId());
		if(isTrue&&msg!=null&&msg.getDirection()==Direction.RECEIVE&&ImageGralleryPagerActivity.isFireMsg&&isFireMsg&&!CCPAppManager.getUserId().equalsIgnoreCase(msg.getForm())){
