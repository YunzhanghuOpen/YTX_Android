...
public class AppPanel extends LinearLayout implements CCPFlipper.OnFlipperPageListener
    ...
    /**
     * width of {@link com.yuntongxun.ecdemo.ui.chatting.view.AppPanel} {@link AppGrid}
     */
    private int mGridWidth;

    /**
     * height of {@link com.yuntongxun.ecdemo.ui.chatting.view.AppPanel} {@link AppGrid}
     */
    ...
    public void onFlipperPage(int startIndex, int finalIndex) {
        if (mAppGrid != null && mAppGrid.size() == 2 && size == 8) {
            return;
        }
        if (mDotView == null) {
            return;
