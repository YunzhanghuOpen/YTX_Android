...
public class SettingsActivity extends ECSuperActivity implements View.OnClickListener {
    ...
    private SettingItem mSettingHuaWei;
    //零钱
    ...
    private void initView() {
        ...
        mSettingSuggest = (SettingItem) findViewById(R.id.settings_suggest);
        mSettingRatio = (SettingItem) findViewById(R.id.settings_ratio);
        mSettingAbout.setOnClickListener(this);
        mSettingRatio.setOnClickListener(this);
        mSettingSuggest.setOnClickListener(this);
        mSettingHuaWei = (SettingItem) findViewById(R.id.settings_huawei);
        mSettingHuaWei.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.settings_suggest:
                ...
                break;
            case R.id.settings_huawei:
                startActivity(new Intent(this, PustDemoActivity.class));
                break;
            default:
                break;
        }
